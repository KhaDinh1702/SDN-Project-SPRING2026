...
const categoryImages: any = {
  fish: require('@/assets/images/categories/ca.jpg'),
  meat: require('@/assets/images/categories/thit.webp'),
  vegetables: require('@/assets/images/categories/rau.jpg'),
  spices: require('@/assets/images/categories/giavi.jpg'),
  fruits: require('@/assets/images/categories/traicay.webp'),
};
    ...
    <ScrollView style={styles.screen} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.categoryGrid}>
          {categories.map((c) => {
            const imageSource =
              categoryImages[c.name?.toLowerCase()] ||
